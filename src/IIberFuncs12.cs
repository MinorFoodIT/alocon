...
{
  [Guid("07722B4B-694A-4F72-BF68-D8963820ECC1")]
  [TypeLibType(4160)]
  [ComImport]
  public interface IIberFuncs12 : IIberFuncs11
  {
    [DispId(1)]
    ...
    [DispId(92)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void StartBreakEx([In] int TermId, [In] int BreakRuleId, [In] int BreakDetailIndex);
  }
}