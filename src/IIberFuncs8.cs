...
{
  [TypeLibType(4160)]
  [Guid("6D6C67B5-7985-441E-91B2-15BA782F2F52")]
  [ComImport]
  public interface IIberFuncs8 : IIberFuncs7
  {
    [DispId(1)]
    ...
    [DispId(70)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    int GetEmployeeIdFromLoginInfo(
      [In] int TermId,
      [In] int ManualEmpNum,
    ...
    [DispId(72)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void StartBreak([In] int TermId, [In] int bIsBreakPaid, [In] int TypeOfBreak);

    [DispId(73)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void EndBreak([In] int TermId);
    ...
    [DispId(75)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void ClearPassword([In] int TermId, [In] int EmpId);

    [DispId(76)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void DeleteClockout([In] int TermId, [In] int EmpId);

    [DispId(77)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void DeleteCheckout([In] int TermId, [In] int EmpId);

    [DispId(78)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void SetExpiredPassword([In] int TermId, [In] int EmployeeId, [MarshalAs(UnmanagedType.BStr), In] string Password, [In] int bIsMagcard);
  }
}
