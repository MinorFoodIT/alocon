...
{
  [TypeLibType(4160)]
  [Guid("0A9005F0-A843-46B9-BE09-AE3F716F94A9")]
  [ComImport]
  public interface IIberFuncs19 : IIberFuncs18
  {
    [DispId(1)]
    ...
    [DispId(109)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void AssignPriceChangeToTable([In] int terminalId, [In] int TableId, [In] int QueueId, [In] int priceChangeId);
  }
}
