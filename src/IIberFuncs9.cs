...
{
  [Guid("91A6F368-80C2-4BB6-82E6-B17F8539D6E0")]
  [TypeLibType(4160)]
  [ComImport]
  public interface IIberFuncs9 : IIberFuncs8
  {
    [DispId(1)]
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string LookupDeliveryCustomer([In] int TermId, [MarshalAs(UnmanagedType.BStr), In] string QueryXML);

    [DispId(80)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string AddDeliveryCustomer([In] int TermId, [MarshalAs(UnmanagedType.BStr), In] string DataXML);

    [DispId(81)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void EditDeliveryCustomer([In] int TermId, [MarshalAs(UnmanagedType.BStr), In] string DataXML);

    [DispId(82)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void DeleteDeliveryCustomer([In] int TermId, [MarshalAs(UnmanagedType.BStr), In] string DataXML);

    [DispId(83)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void AssignDeliveryCustomer([In] int TermId, [In] int CheckId, [In] int QueueId, [MarshalAs(UnmanagedType.BStr), In] string DataXML);

    [DispId(84)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void UnassignDeliveryCustomer([In] int TermId, [In] int CheckId, [In] int QueueId, [MarshalAs(UnmanagedType.BStr), In] string DataXML);
  }
}
