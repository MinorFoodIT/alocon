...
{
  [Guid("C9E1A5E2-5D2A-4B9E-ACB2-870F82032D12")]
  [TypeLibType(4160)]
  [ComImport]
  public interface IIberFuncs7 : IIberFuncs6
  {
    [DispId(1)]
    ...
    [DispId(59)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    int GetEFreqStatus([In] int TermId, [In] int CheckId);

    [DispId(60)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void AssignEFreqMember(
      [In] int TermId,
      [In] int EmpId,
      [In] int TableId,
      [In] int CheckId,
    ...
    [DispId(61)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void UnassignEFreqMember([In] int TermId, [In] int EmpId, [In] int TableId, [In] int CheckId);

    [DispId(62)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void ReassignEFreqMember([In] int TermId, [In] int EmpId, [In] int TableId, [In] int CheckId);

    [DispId(63)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void DeleteEFreqMember([In] int TermId, [In] int EmpId, [In] int TableId, [In] int CheckId);

    [DispId(64)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    int TransferEFreqMember(
      [In] int TermId,
      [In] int EmpId,
      [In] int TableId,
      [In] int OldCheckId,
    ...
    [DispId(65)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void ReportOnEFreqMember([In] int TermId, [In] int EmpId, [MarshalAs(UnmanagedType.BStr), In] string EFreqMemberId);

    [DispId(66)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void LookupEFreqMember([In] int TermId, [In] int EmpId, [MarshalAs(UnmanagedType.BStr), In] string LookupText);

    [DispId(67)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void PerformCashDrawerPaidInOut(
      [In] int TermId,
      [In] int EmpId,
      [In] int MgrId,
      [In] int DrawerId,
    ...
    [DispId(69)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void ReportOnEFreqMemberOnCheck([In] int TermId, [In] int EmpId, [In] int CheckId);
  }
}
