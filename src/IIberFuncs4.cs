...
{
  [Guid("EC0277E0-E168-E1D4-856D-00105ACA290D")]
  [TypeLibType(4160)]
  [ComImport]
  public interface IIberFuncs4 : IIberFuncs3
  {
    [DispId(1)]
    ...
    [DispId(35)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void SetObjectAttribute([In] int ObjectClassId, [In] int ObjectId, [MarshalAs(UnmanagedType.BStr), In] string Name, [MarshalAs(UnmanagedType.BStr), In] string Value);

    [DispId(36)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string GetObjectAttribute([In] int ObjectClassId, [In] int ObjectId, [MarshalAs(UnmanagedType.BStr), In] string Name);

    [DispId(37)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string Authenticate([MarshalAs(UnmanagedType.BStr), In] string Input);

    [DispId(38)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void AdjustPayment([In] int TermId, [In] int CheckId, [In] int PaymentId, [In] double amount, [In] double Tip);

    [DispId(39)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void DeletePayment([In] int TermId, [In] int CheckId, [In] int PaymentId);

    [DispId(40)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void DisplayMessage([MarshalAs(UnmanagedType.BStr), In] string Message);
  }
}
