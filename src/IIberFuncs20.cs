...
namespace AlohaFOHLib
{
  ...
  [ComImport]
  public interface IIberFuncs20 : IIberFuncs19
  {
    [DispId(1)]
    ...
    [DispId(102)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void BeginGetTable([In] int TermId, [In] int TableNum, [MarshalAs(UnmanagedType.BStr), In] string TableNameAsBSTR);

    [DispId(103)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void EndGetTable([In] int TermId);

    [DispId(104)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void ClearDanglingOrderLock([In] int TermId);

    [DispId(109)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void AssignPriceChangeToTable([In] int terminalId, [In] int TableId, [In] int QueueId, [In] int priceChangeId);

    [DispId(105)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void ManagerVoidSelectedItems([In] int TermId, [In] int ManagerId, [In] int CheckId, [In] int VoidReasonId);

    [DispId(106)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void VoidSelectedItems([In] int TermId, [In] int CheckId, [In] int VoidReasonId);

    [DispId(107)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_I4)]
    int[] GetDrawersAssignedToEmployee([In] int EmpId);

    [DispId(108)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_I4)]
    int[] GetEmployeesAssignedToDrawer([In] int DrawerId);

    [DispId(110)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void RenameTab([In] int TermId, [In] int TableId, [MarshalAs(UnmanagedType.BStr), In] string tabNameAsBSTR);
  }
}
