...
{
  [TypeLibType(4160)]
  [Guid("6A370864-C503-480E-847F-30251746EDFC")]
  [ComImport]
  public interface IIberFuncs15 : IIberFuncs14
  {
    [DispId(1)]
    ...
    [DispId(97)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void GetEqualPaySplitGuestCount([In] int TermId, [In] int CheckId, out int NumberOfSplits);

    [DispId(98)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void SelectEqualPayGuest([In] int TermId, [In] int CheckId, [In] int GuestToSelect);
  }
}
